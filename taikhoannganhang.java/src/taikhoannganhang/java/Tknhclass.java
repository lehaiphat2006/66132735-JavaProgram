...
public class Tknhclass {
	//TaiKhoanNganHang.java 
	    ...
	    public Tknhclass(String soTaiKhoan) {
	    ...
	    public Tknhclass(String soTaiKhoan, String tenChuTaiKhoan) {
	        this.soTaiKhoan = soTaiKhoan;
	    ...
	    public Tknhclass(String soTaiKhoan, String tenChuTaiKhoan, double soDu) {
	        this.soTaiKhoan = soTaiKhoan;
	        this.tenChuTaiKhoan = tenChuTaiKhoan;
